...
//   // Single useEffect to handle initialization, search, and pagination
//   useEffect(() => {
//     if (!currentUser) {
//       console.log("No currentUser, skipping fetchData");
//       setLoading(false); // Prevent infinite loading if user data is missing
//       return;
//     }
...
//     // Focus search input on mount and trigger initial fetch
...
//         setPermissionsUpdated(Date.now());
//       }
//     };
...
//         id: "actions",
//         Cell: ({ row }) => {
//           // Get permissions from Redux or fallback to localStorage
...
//                 currentPermissions
//               )) ||
//             hasAnyPermission(currentUser, ["user:update"], currentPermissions);
...
//                 currentPermissions
//               )) ||
//             hasAnyPermission(currentUser, ["user:delete"], currentPermissions);
...
//                 currentPermissions
//               )) ||
//             hasAnyPermission(currentUser, ["user:block"], currentPermissions);
...
//       },
//     ],
//     [loading, deletingId, permissionsUpdated]
//   );
