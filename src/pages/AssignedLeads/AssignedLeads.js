...
const UserLeads = ({ userId }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      //       validateStatus(row.original.status)
      //     );
      //     const [isUpdating, setIsUpdating] = useState(false);
      //     const [isDisabled, setIsDisabled] = useState(
      //       row.original.status_updated || state.activeTab !== "all"
      //     );
      ...
      //         toast.warning("This lead is already marked as sold");
      //         return;
      //       }
      ...
      //               currentStat const updatedAssigneesus
      //             )}`}
      //             style={{
      //               color: "white",
