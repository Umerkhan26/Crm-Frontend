...
//       // Check if navigating from campaign or order context
//       if (campaignId && pathname.includes("/order-index")) {
...
//     // Reinitialize menu on pathname or search change
//     return () => {
//       if (metisRef.current) {
//         metisRef.current.dispose();
//       }
...
//               </li>
//               <li>
//                 <Link to="/user-register">{props.t("User Registration")}</Link>
//               </li>
//               <li>
//                 <Link to="/all-client">{props.t("Clientele")}</Link>
//               </li>
